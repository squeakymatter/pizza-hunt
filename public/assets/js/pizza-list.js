...
//integrate db with front end
//get pizza data, transform it into JSON, run each one through the printPizza function using.forEach mehod. Then call this function on load using getPizzaList() at the end.
const getPizzaList = () => {
  fetch("/api/pizzas")
